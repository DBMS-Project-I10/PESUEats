...
-- MENU_ITEM
ALTER TABLE MENU_ITEM ADD CONSTRAINT FK_IINMENURID FOREIGN KEY(IinMenuRid) REFERENCES RESTAURANT(Rid);
...
-- DELIVERY_AGENT
ALTER TABLE DELIVERY_AGENT ADD CONSTRAINT FK_DAHASWID FOREIGN KEY(DAhasWid) REFERENCES WALLET(Wid);

-- FOOD_ORDER
ALTER TABLE FOOD_ORDER ADD CONSTRAINT FK_OFROMRID FOREIGN KEY(OfromRid) REFERENCES RESTAURANT(Rid);
ALTER TABLE FOOD_ORDER ADD CONSTRAINT FK_ODAID FOREIGN KEY(ODAid) REFERENCES DELIVERY_AGENT(DAid);
